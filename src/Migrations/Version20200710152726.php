 ...
 */
final class Version20200710152726 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, id_categorie_id INT NOT NULL, nom_produit VARCHAR(50) NOT NULL, prenom_produit VARCHAR(50) NOT NULL, prix_produit INT NOT NULL, image_produit VARCHAR(100) NOT NULL, INDEX IDX_29A5EC279F34925F (id_categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
